...
const QuestionDiv: React.FC<QuestionProps> = ({ question, answer }) => {
  return (
    <div className="flex w-[50%] flex-col text-white font-spacegrotesk rounded-lg border border-white p-5">
      <div className="flex w-full">
        <div className="w-[5%] relative mr-5 hover:rotate-45 transition-transform duration-300">
          <div className="w-[2px] h-4 bg-white absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]" />
          <div className="h-[2px] w-4 bg-white absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]" />
        </div>
...
const FAQSection = () => {
  return (
    <section className='bg-[#990000] relative overflow-hidden min-h-screen w-auto '>
      <div className="absolute right-[8%] -top-[5%] opacity-50 scale-125">
        {svg}
      </div>
      <div className="absolute left-[8%] -bottom-[5%] opacity-50 scale-150">
        {svg}
      </div>
      <div className='py-20 flex w-full flex-col items-center gap-8'>
        <h1 className="text-[34px] font-orbitron font-black leading-[120%] text-center text-white">
          FREQUENTLY<br></br>
          ASKED QUESTIONS
        </h1>
